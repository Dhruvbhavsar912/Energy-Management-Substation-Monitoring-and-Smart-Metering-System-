...
class Industry3Screen extends StatefulWidget {
  static String id ="industry3";
  @override
  _Industry3ScreenState createState() => _Industry3ScreenState();
}

class _Industry3ScreenState extends State<Industry3Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Industry3 Parameters'),
