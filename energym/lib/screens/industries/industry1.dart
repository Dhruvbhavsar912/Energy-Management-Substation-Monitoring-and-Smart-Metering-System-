...
class Industry1Screen extends StatefulWidget {
  static String id ="industry1";
  @override
  _Industry1ScreenState createState() => _Industry1ScreenState();
}

class _Industry1ScreenState extends State<Industry1Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Industry1 Parameters'),
