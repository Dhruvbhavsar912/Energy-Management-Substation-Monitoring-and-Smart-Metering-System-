...
class Industry2Screen extends StatefulWidget {
  static String id ="industry2";
  @override
  _Industry2ScreenState createState() => _Industry2ScreenState();
}

class _Industry2ScreenState extends State<Industry2Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Industry2 Parameters'),
