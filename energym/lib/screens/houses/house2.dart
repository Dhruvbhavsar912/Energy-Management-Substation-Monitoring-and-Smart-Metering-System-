...
class House2Screen extends StatefulWidget {
  static String id ="house2";
  @override
  _House2ScreenState createState() => _House2ScreenState();
}

class _House2ScreenState extends State<House2Screen> {
